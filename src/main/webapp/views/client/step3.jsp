            ...
            <section id="body-content">
                <div id="steps" class="container">
                    <ul class="list-step clearfix">
                        ...
                        <li class="active">Thông tin khách hàng <span></span></li>
                ...
                <div id="content-steps" class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-ms-12">
                            <div class="panel">
                                <p class="text-center text-primary text-uppercase">Thông tin khách hàng</p>
                                <form id="form-cus-info" class="form-horizontal" action="">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="" placeholder="Tên của bạn">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">CMNN/<br> PASSPORT *</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="" placeholder="0902 1818 52">
                                            </div>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Số điện thoại 2</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="" placeholder="">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                           <div class="checkbox col-md-9 col-md-offset-3 ">
                                            <label>
                                              <input type="checkbox"> Chấp nhận điều khoản
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-ms-12">
                            <div class="panel">
                                <p class="text-center text-uppercase text-primary"><strong>Điều khoản & Lưu ý</strong></p>
                                <p>(*) Quý khách vui lòng mang email có chứa mã đặt chỗ để đổi vé lên xe trước giờ xuất bến ít nhất 30ph</p>
