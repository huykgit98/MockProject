            ...
            <section id="body-content">
                ...
                <div class="bg-success">
                    <div class="container">
                        ...
                        <div id="card" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12 col-ms-12">
                            <div class="card-head bg-primary text-center">
                                <span class="fa fa-check-circle text-white fa-2x"></span> 
                                <h3 class="text-uppercase text-white no-margin">Thanh toán thành công</h3>
                            </div>
