...
<html>
<head>
	<title>jQuery Pagination Tables Plugin Demo</title>
	<meta charset="UTF-8">
...
<ul>
<li><a href="http://www.jqueryscript.net/table/Minimal-Bootstrap-Table-Pagination-Plugin-With-jQuery-Pagination-Tables.html">Download This Plugin</a></li>
